...
#if defined(NDEBUG)
#error "MNDX cannot be compiled without assertions."
#endif
...
int64_t GetBlockValue(int nHeight)
{
    ...
    if (nHeight == 0) {
      ...
      nSubsidy = 1 * COIN;    
    } else if (nHeight > 7200 && nHeight <= 11520) {
      nSubsidy = 5 * COIN;    
    } else if (nHeight > 11520 && nHeight <= 15840) {
      nSubsidy = 10 * COIN;      
    } else if (nHeight > 15840 && nHeight <= 20160) {
      nSubsidy = 20 * COIN;      
    } else if (nHeight > 20160 && nHeight <= 24480) {
      nSubsidy = 40 * COIN;      
    } else if (nHeight > 24480 && nHeight <= 28800) {
      nSubsidy = 60 * COIN;      
    } else if (nHeight > 28800 && nHeight <= 33120) {
      nSubsidy = 80 * COIN;
    } else if (nHeight > 33120 && nHeight <= 76320) {
      nSubsidy = 30 * COIN;
    } else if (nHeight > 76320 && nHeight <= 119520) {
      nSubsidy = 10 * COIN;      
    } else if (nHeight > 119520) {
      nSubsidy = 5 * COIN;      
    }
