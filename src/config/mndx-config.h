/* src/config/mndx-config.h.  Generated from mndx-config.h.in by configure.  */
/* src/config/mndx-config.h.in.  Generated from configure.ac by autoheader.  */

#ifndef Mndx_CONFIG_H

#define Mndx_CONFIG_H
...
#define PACKAGE_BUGREPORT "mnd.exchange"

/* Define to the full name of this package. */
#define PACKAGE_NAME "Mndx Core"

/* Define to the full name and version of this package. */
#define PACKAGE_STRING "Mndx Core 1.0.0"

/* Define to the one symbol short name of this package. */
#define PACKAGE_TARNAME "mndx"
