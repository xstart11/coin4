...
void BitcoinGUI::createActions(const NetworkStyle* networkStyle)
{
    ...
    sendCoinsAction->setStatusTip(tr("Send coins to a MNDX address"));
    ...
    receiveCoinsAction->setStatusTip(tr("Request payments (generates QR codes and mndx: URIs)"));
    ...
    aboutAction = new QAction(networkStyle->getAppIcon(), tr("&About Mndx"), this);
    aboutAction->setStatusTip(tr("Show information about Mndx"));
    ...
    optionsAction->setStatusTip(tr("Modify configuration options for MNDX"));
    ...
    signMessageAction->setStatusTip(tr("Sign messages with your MNDX addresses to prove you own them"));
    verifyMessageAction = new QAction(QIcon(":/icons/transaction_0"), tr("&Verify message..."), this);
    verifyMessageAction->setStatusTip(tr("Verify messages to ensure they were signed with specified MNDX addresses"));
    ...
    openAction->setStatusTip(tr("Open a MNDX: URI or payment request"));

    showHelpMessageAction = new QAction(QApplication::style()->standardIcon(QStyle::SP_MessageBoxInformation), tr("&Command-line options"), this);
    showHelpMessageAction->setMenuRole(QAction::NoRole);
    showHelpMessageAction->setStatusTip(tr("Show the Mndx help message to get a list with possible MNDX command-line options"));
...
void BitcoinGUI::createTrayIcon(const NetworkStyle* networkStyle)
{
    ...
    QString toolTip = tr("Mndx client") + " " + networkStyle->getTitleAddText();
...
void BitcoinGUI::setNumConnections(int count)
{
    ...
    labelConnectionsIcon->setToolTip(tr("%n active connection(s) to MNDX network", "", count));
}
...
{
    QString strTitle = tr("Mndx"); // default title
