...
CAmount AmountFromValue(const Value& value)
{
    ...
    if (dAmount <= 0.0 || dAmount > 11000000.0)
...
static const CRPCCommand vRPCCommands[] =
    {
        ...
        /* Mndx features */
        {"mndx", "masternode", &masternode, true, true, false},
        {"mndx", "listmasternodes", &listmasternodes, true, true, false},
        {"mndx", "getmasternodecount", &getmasternodecount, true, true, false},
        {"mndx", "masternodeconnect", &masternodeconnect, true, true, false},
        {"mndx", "masternodecurrent", &masternodecurrent, true, true, false},
        {"mndx", "masternodedebug", &masternodedebug, true, true, false},
        {"mndx", "startmasternode", &startmasternode, true, true, false},
        {"mndx", "createmasternodekey", &createmasternodekey, true, true, false},
        {"mndx", "getmasternodeoutputs", &getmasternodeoutputs, true, true, false},
        {"mndx", "listmasternodeconf", &listmasternodeconf, true, true, false},
        {"mndx", "getmasternodestatus", &getmasternodestatus, true, true, false},
        {"mndx", "getmasternodewinners", &getmasternodewinners, true, true, false},
        {"mndx", "getmasternodescores", &getmasternodescores, true, true, false},
        {"mndx", "mnbudget", &mnbudget, true, true, false},
        {"mndx", "preparebudget", &preparebudget, true, true, false},
        {"mndx", "submitbudget", &submitbudget, true, true, false},
        {"mndx", "mnbudgetvote", &mnbudgetvote, true, true, false},
        {"mndx", "getbudgetvotes", &getbudgetvotes, true, true, false},
        {"mndx", "getnextsuperblock", &getnextsuperblock, true, true, false},
        {"mndx", "getbudgetprojection", &getbudgetprojection, true, true, false},
        {"mndx", "getbudgetinfo", &getbudgetinfo, true, true, false},
        {"mndx", "mnbudgetrawvote", &mnbudgetrawvote, true, true, false},
        {"mndx", "mnfinalbudget", &mnfinalbudget, true, true, false},
        {"mndx", "checkbudgets", &checkbudgets, true, true, false},
        {"mndx", "mnsync", &mnsync, true, true, false},
        {"mndx", "spork", &spork, true, true, false},
        {"mndx", "getpoolinfo", &getpoolinfo, true, true, false},
#ifdef ENABLE_WALLET
        {"mndx", "obfuscation", &obfuscation, false, false, true}, /* not threadSafe because of SendMoney */
...
void StartRPCThreads()
{
    ...
    if (((mapArgs["-rpcpassword"] == "") ||
        ...
        uiInterface.ThreadSafeMessageBox(strprintf(
                                             _("To use mndxd, or the -server option to mndx-qt, you must set an rpcpassword in the configuration file:\n"
                                               "%s\n"
...
{
    return "> mndx-cli " + methodname + " " + args + "\n";
}
...
std::string HelpExampleRpc(string methodname, string args)
{
    return "> curl --user myusername --data-binary '{\"jsonrpc\": \"1.0\", \"id\":\"curltest\", "
           "\"method\": \"" +
           methodname + "\", \"params\": [" + args + "] }' -H 'content-type: text/plain;' http://127.0.0.1:7181/\n";
}
