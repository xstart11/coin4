Contributing to Mndx
============================

The Mndx project operates an open contributor model where anyone is
...
The following applies to code changes to the Mndx project, and is not to be
confused with overall MNDX Network Protocol consensus changes.

Whether a pull request is merged into Mndx rests with the project merge
...
Patches that change MNDX consensus rules are considerably more involved than
...
Where a patch set proposes to change the MNDX consensus, it must have been
...
The project leader is the release manager for each Mndx release.
