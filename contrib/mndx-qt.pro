...
RESOURCES += src/qt/mndx.qrc src/qt/mndx_locale.qrc

TRANSLATIONS += src/qt/locale/mndx_bg.ts \
                src/qt/locale/mndx_de.ts \
                src/qt/locale/mndx_en.ts \
                src/qt/locale/mndx_es.ts \
                src/qt/locale/mndx_fi.ts \
                src/qt/locale/mndx_fr.ts \
                src/qt/locale/mndx_it.ts \
                src/qt/locale/mndx_ja.ts \
                src/qt/locale/mndx_pl.ts \
                src/qt/locale/mndx_pt.ts \
                src/qt/locale/mndx_ru.ts \
                src/qt/locale/mndx_sk.ts \
                src/qt/locale/mndx_sv.ts \
                src/qt/locale/mndx_vi.ts \
                src/qt/locale/mndx_zh_CN.ts \
                src/qt/locale/mndx_zh_TW.ts
