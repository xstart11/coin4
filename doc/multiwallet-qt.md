...
In order to support loading of multiple wallets in mndx-qt, a few changes in the UI architecture will be needed.
...
Only requiring some minor changes is mndx.cpp.
...
Changes to mndx.cpp
----------------------
mndx.cpp is the entry point into mndx-qt, and as such, will require some minor modifications to provide hooks for
